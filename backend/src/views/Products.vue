    ...
    <div class="bg-white p-4 rounded-lg shadow">
        <div class="flex justify-between border-b-2 pb-3">
            <div class="flex items-center">
                <span class="whitespace nowrap mr-3"></span>
                <select @change="getProducts(null)" v-model="perPage" name="" id=""
                    class="appearance-none relative block w-24 px-3 py-2
            ...
            <div class="">
                <input v-model="search" @change="getProducts(null)" type="text"
        ...
        <template v-else>
            ...
            <div class="flex justify-between items-center mt-5">
                <span>
                    Showing from {{ products.form }} to {{ products.to }}
                </span>
                <nav
                    v-if="products.total >products.limit"
                    class="relative z-0 inflex justidy-center rounded-md
                        shadow-sm -space-x-px"
